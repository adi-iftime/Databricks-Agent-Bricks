...
name: code-review
description: >-
  Reviews pull requests across correctness, readability, architecture, security, and performance; produces prioritized actionable feedback without drive-by refactors. Use when reviewing pull requests, validating implementation quality, assessing architecture consistency, or before merge.
---
...
**Approval standard:** Approve when the change clearly improves overall code health, even if imperfect. Do not block solely because it is not exactly how you would have written it.
...
For detailed security guidance, see **security-review** skill. Does the change introduce vulnerabilities?
...
For detailed profiling and optimization, see **performance-optimization** skill. Does the change introduce performance problems?
